                                    ...
                                    <form action="{{ route('register.store') }}" method="POST">
                                        ...
                                        <div data-mdb-input-init class="form-outline form-white mb-4">
                                            <input type="text" id="login" name="login"
                                                class="form-control form-control-lg" value="{{ old('login') }}"
                                                placeholder="Логин" />
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                                class="btn btn-outline-light btn-lg px-5">Зарегистрироваться</button>
                                        </div>

                                        <p class="text-center text-muted mt-5 mb-0 text-white-50">Уже есть аккаунт? <a
                                                href="{{ route('login.form') }}"
                                                class="text-white-50 fw-bold"><u>Войти</u></a></p>
                                    </form>
                                </div>
                            </div>
                        </div>
