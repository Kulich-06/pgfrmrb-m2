...
<head>
  ...
  <style>
    html, body {
        height: 100%; /* Делаем страницу на всю высоту */
        margin: 0;
    }
    .wrapper {
        display: flex;
    ...
    .content {
        flex: 1; /* Занимает всю доступную высоту, выталкивая футер вниз */
    }
    footer {
    ...
    <header>
      <nav class="navbar bg-dark">
        <div class="container-fluid">
          ...
          <a class="nav-link active text-white-50 fw-bold" aria-current="page" href="{{ route('index') }}">Главная</a>
          <a class="nav-link active text-white-50 fw-bold" aria-current="page" href="{{ route('collection.index') }}">Коллекции</a>
          @guest
