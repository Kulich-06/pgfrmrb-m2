        ...
        <div class="card bg-dark text-white" style="max-width: 450px; width: 100%; border-radius: 1rem;">
            <div class="card-body p-4 p-sm-5">
                ...
                <div id="alertContainer"
                    style="position: fixed; top: 20px; width: 100%; pointer-events: none; z-index: 1050;"></div>

                <form id="clotchForm" method="POST" action="{{ route('clotch.store') }}" enctype="multipart/form-data"
                    autocomplete="off">
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input type="text" id="size" name="size" class="form-control bg-opacity-25 border-0 "
                            placeholder="Размер" required>
                    </div>

                    <div class="mb-3 text-start">
                        <label for="img" class="form-label">Изображение</label>
                        <input type="file" id="img" name="img" accept="image/*"
                            class="form-control bg-opacity-25 border-0 " required>
                    </div>
                                ...
                                reader.onload = function(event) {
                                    ...
                                    resizeImage(event.target.result, 300, 300, function(resizedImg) {
                                        const clotch = {
                                            ...
                                            category: document.getElementById('category').selectedOptions[0]
                                                .text,
                                            color: document.getElementById('color').selectedOptions[0].text,
                                            season: document.getElementById('season').selectedOptions[0]
                                                .text,
                                            img: resizedImg
                                        };
                                        ...
                                        try {
                                            localStorage.setItem('guestClotches', JSON.stringify(
                                            guestClotches));
