...
<div class="container d-flex justify-content-center align-items-center" style="padding-top: 230px; padding-bottom: 60px;">
    <div class="card bg-dark text-white"
        ...
        <div class="card-body p-4">
            ...
            @else
                <p class="text-center text-warning fs-5">Вы не авторизованы. <a href="{{ route('login') }}" class="text-decoration-underline text-info">Войдите</a>, чтобы просмотреть профиль.</p>
            @endif
